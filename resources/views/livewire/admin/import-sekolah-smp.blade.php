<div>
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h4 class="mb-1">Import Data Sekolah SMP</h4>
            <p class="text-muted mb-0">Upload data sekolah SMP masal menggunakan file CSV.</p>
        </div>
        <div>
            <a href="{{ route('admin.sekolah-smp') }}" class="btn btn-secondary" wire:navigate>
