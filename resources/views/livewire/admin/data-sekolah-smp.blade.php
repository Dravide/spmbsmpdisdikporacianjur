<div>
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h4 class="mb-1">Data Sekolah Menengah Pertama (SMP)</h4>
            <p class="text-muted mb-0">Kelola data sekolah SMP dan akun operator.</p>
        </div>
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('admin.sekolah-smp.import') }}" class="btn btn-primary" wire:navigate>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($sekolah->mode_spmb == 'Full Online')
                                        <span class="badge bg-primary-subtle text-primary">Full Online</span>
                                    @else
                                        <span class="badge bg-warning-subtle text-warning">Semi Online</span>
                                    @endif
                                </td>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Detail Sekolah SMP</h5>
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="mb-0">
                                    @if($selectedSekolah->mode_spmb == 'Full Online')
                                        <span class="badge bg-primary-subtle text-primary">Full Online</span>
                                    @else
                                        <span class="badge bg-warning-subtle text-warning">Semi Online</span>
                                    @endif
    ...
    @if($showCreateModal)
        <div class="modal fade show d-block" tabindex="-1" style="background: rgba(0,0,0,0.5);">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">{{ $isEditMode ? 'Edit Data Sekolah SMP' : 'Tambah Sekolah SMP Baru' }}</h5>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('form.nama') is-invalid @enderror"
                                    wire:model="form.nama" placeholder="Contoh: SMPN 1 CIANJUR">
                            ...
                            <div class="col-md-6">
                                <label class="form-label">Mode SPMB <span class="text-danger">*</span></label>
                                <select class="form-select @error('form.mode_spmb') is-invalid @enderror"
                                    wire:model="form.mode_spmb">
                                    <option value="Full Online">Full Online</option>
                                    <option value="Semi Online">Semi Online</option>
                                </select>
        ...
        <script>
            function confirmReset() {
                Swal.fire({
                    ...
                    text: "Semua data sekolah SMP akan dihapus! User OPSMP akan di-unlink.",
                    icon: 'warning',
