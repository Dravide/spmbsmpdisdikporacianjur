<div>
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h4 class="mb-1">Dashboard Operator SD</h4>
    ...
    <div class="row">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center mb-4">
                            <div class="avatar avatar-lg bg-primary bg-opacity-10 text-primary rounded-circle me-3">
                                <i class="fi fi-rr-school" style="font-size: 1.5rem;"></i>
                            </div>
                            <div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <h6 class="card-title text-muted mb-3">Status Pendaftaran</h6>
                    <!-- Placeholder stats -->
