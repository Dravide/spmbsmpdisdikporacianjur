                        ...
                        <div class="p-4 p-lg-5">
                            ...
                            @if(!$scheduleOpen)
                                <div class="text-center py-5">
                                    <div class="mb-4">
                                        <div class="avatar avatar-xxl bg-danger-subtle text-danger rounded-circle d-flex align-items-center justify-content-center mx-auto" style="width: 80px; height: 80px;">
                                            <i class="fi fi-rr-calendar-clock fs-1"></i>
                                        </div>
                                    </div>
                                    <h4 class="fw-bold mb-3">Pendaftaran Ditutup</h4>
                                    <p class="text-muted fs-6 mb-4">{{ $scheduleMessage }}</p>
                                    ...
                                    <a href="{{ route('login') }}" class="btn btn-primary">
                                        <i class="fi fi-rr-arrow-left me-1"></i> Kembali ke Login
                                    </a>
                                </div>
                            @else
                                <!-- Progress Indicator -->
