            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <strong>{{ $pendaftaran->pesertaDidik->tempat_lahir ?? '-' }},
                        {{ $pendaftaran->pesertaDidik->tanggal_lahir ? \Carbon\Carbon::parse($pendaftaran->pesertaDidik->tanggal_lahir)->format('d/m/Y') : '-' }}</strong>
                </div>
                <div class="col-md-4">
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <strong>{{ $pendaftaran->created_at ? $pendaftaran->created_at->format('d/m/Y H:i') : '-' }}</strong>
                </div>
                <div class="col-md-3">
                ...
                @if($pendaftaran->jarak)
                    <div class="col-md-3">
                        <small class="text-muted d-block">Jarak ke Sekolah</small>
                        <strong>{{ number_format($pendaftaran->jarak, 2) }} km</strong>
                    </div>
                @endif
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <button class="btn btn-sm btn-outline-primary"
                                        onclick="openPdfPreview('{{ asset('storage/' . $item->file_path) }}', '{{ $item->berkas->nama ?? 'Berkas' }}')"
                                        title="Preview">
...
@push('scripts')
    ...
    <script>
        ...
        function openPdfPreview(fileUrl, fileName) {
